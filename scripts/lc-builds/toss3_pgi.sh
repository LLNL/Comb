...
cmake \
  ...
  -DMPI_CXX_COMPILER=/usr/tce/packages/mvapich2/mvapich2-2.3-pgi-${COMP_VER}/bin/mpic++ \
  -DMPI_C_COMPILER=/usr/tce/packages/mvapich2/mvapich2-2.3-pgi-${COMP_VER}/bin/mpicc \
