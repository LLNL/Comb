...
if (ENABLE_CUDA)
  ...
  if (NOT COMB_HOST_CONFIG_LOADED)
    list(APPEND COMB_EXTRA_NVCC_FLAGS -restrict; -arch ${CUDA_ARCH}; -std ${COMB_NVCC_STD}; --expt-extended-lambda; -ccbin; ${CMAKE_CXX_COMPILER})

    set(COMB_NVCC_FLAGS_RELEASE -O3 CACHE STRING "")
    set(COMB_NVCC_FLAGS_DEBUG -g; -G; -O0 CACHE STRING "")
    set(COMB_NVCC_FLAGS_MINSIZEREL -Os CACHE STRING "")
    set(COMB_NVCC_FLAGS_RELWITHDEBINFO -g; -lineinfo; -O2 CACHE STRING "")

    if(COMB_ENABLE_COVERAGE)
      if (CMAKE_CXX_COMPILER_ID MATCHES GNU)
        message(INFO "Coverage analysis enabled")
        set(COMB_EXTRA_NVCC_FLAGS ${COMB_EXTRA_NVCC_FLAGS}; -Xcompiler -coverage; -Xlinker -coverage)
        set(CMAKE_EXE_LINKER_FLAGS "-coverage ${CMAKE_EXE_LINKER_FLAGS}")
      else()
  ...
  set(COMB_NVCC_FLAGS ${COMB_EXTRA_NVCC_FLAGS} CACHE STRING "")
  set(CUDA_NVCC_FLAGS ${COMB_NVCC_FLAGS})
  set(CUDA_NVCC_FLAGS_RELEASE ${COMB_NVCC_FLAGS_RELEASE})
  set(CUDA_NVCC_FLAGS_DEBUG ${COMB_NVCC_FLAGS_DEBUG})
  set(CUDA_NVCC_FLAGS_MINSIZEREL ${COMB_NVCC_FLAGS_MINSIZEREL})
  set(CUDA_NVCC_FLAGS_RELWITHDEBINFO ${COMB_NVCC_FLAGS_RELWITHDEBINFO})
endif()
